...
subprocess.call (["/usr/local/bin/Rscript", "--vanilla", "/Users/metehangelgi/Desktop/Fall2021/indr491/PipeStructure/lasso.r"])
...
def writeToCSV(coefDF,Xs,Ys):
    ...
    filename = "featureCreation/" + "new"+ ".csv" # fileName ver
